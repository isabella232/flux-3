...
flowchart TB
    ...
    program-.->semantic_graph_for_package
    ...
    subgraph Execution
        ...
        wait_for_transformations[Wait for Transformations to Finish]
        
        construct_execution_graph_object-->execution_graph_object
        execution_graph_object-->run_sources
        run_sources-->wait_for_transformations
    end
